...
"""
╔══════════════════════════════════════════════════════════════════════╗
║         Koni's Archive – 무료 버전 (Gemini + Pollinations)           ║
╚══════════════════════════════════════════════════════════════════════╝

필요한 라이브러리 설치:
    pip3 install google-generativeai pillow requests python-dotenv

API 키 준비:
    Google Gemini API 키 (무료) →  https://aistudio.google.com/app/apikey
    .env 파일에 저장:
...
def generate_content(korean: str) -> dict:
    ...
    response = model.generate_content(PROMPT_TEMPLATE.format(korean=korean))
    ...
    for field in required:
        if field not in data:
            raise ValueError(f"Gemini 응답에 필드 없음: '{field}'")
...
def main():
    print("=" * 58)
    print("      ✨  Koni's Archive – 무료 버전 (Gemini)  ✨")
    print("=" * 58)
